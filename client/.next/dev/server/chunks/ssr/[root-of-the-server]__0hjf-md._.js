...
"[project]/OneDrive/Desktop/Projects-for-portfolio-versions/multi-tenant hospitality/client/app/admin/menu/page.jsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
function MenuPage() {
    const { propertyId, user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Projects$2d$for$2d$portfolio$2d$versions$2f$multi$2d$tenant__hospitality$2f$client$2f$store$2f$useAdminStore$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAdminStore"])();
    ...
    const loadData = async ()=>{
        ...
        try {
            const [categoriesRes, itemsRes] = await Promise.all([
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Projects$2d$for$2d$portfolio$2d$versions$2f$multi$2d$tenant__hospitality$2f$client$2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getCategories"])(effectivePropertyId),
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Projects$2d$for$2d$portfolio$2d$versions$2f$multi$2d$tenant__hospitality$2f$client$2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMenuItems"])(effectivePropertyId)
            ]);
            setCategories(categoriesRes.data.data);
            setItems(itemsRes.data.data);
        } catch (err) {
            __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Projects$2d$for$2d$portfolio$2d$versions$2f$multi$2d$tenant__hospitality$2f$client$2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Failed to load menu data");
        } finally{
            setLoading(false);
        }
    };
    const fetchProperties = async ()=>{
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Projects$2d$for$2d$portfolio$2d$versions$2f$multi$2d$tenant__hospitality$2f$client$2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getProperties"])();
            setProperties(res.data.data);
        } catch (err) {
            __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Projects$2d$for$2d$portfolio$2d$versions$2f$multi$2d$tenant__hospitality$2f$client$2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Failed to load properties");
        }
    };
    const handleCreateCategory = async ()=>{
        if (!categoryForm.name.trim()) {
            __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Projects$2d$for$2d$portfolio$2d$versions$2f$multi$2d$tenant__hospitality$2f$client$2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Category name is required");
            return;
        }
        if (user?.role === "super_admin" && !categoryForm.propertyId && !selectedPropertyId) {
            __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Projects$2d$for$2d$portfolio$2d$versions$2f$multi$2d$tenant__hospitality$2f$client$2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Property is required");
            return;
        }
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Projects$2d$for$2d$portfolio$2d$versions$2f$multi$2d$tenant__hospitality$2f$client$2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createCategory"])({
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Projects$2d$for$2d$portfolio$2d$versions$2f$multi$2d$tenant__hospitality$2f$client$2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Category created!");
        } catch (err) {
            console.error("Create category error:", err);
            __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Projects$2d$for$2d$portfolio$2d$versions$2f$multi$2d$tenant__hospitality$2f$client$2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(err.response?.data?.error || "Failed to create category");
        }
    };
    ...
    const handleCreateOrUpdateItem = async ()=>{
        if (!itemForm.name.trim() || !itemForm.price) {
            __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Projects$2d$for$2d$portfolio$2d$versions$2f$multi$2d$tenant__hospitality$2f$client$2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Please fill in all fields");
            return;
        }
        ...
        try {
            ...
            if (editingItem) {
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Projects$2d$for$2d$portfolio$2d$versions$2f$multi$2d$tenant__hospitality$2f$client$2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateMenuItem"])(editingItem._id, payload);
                setItems((prev)=>prev.map((i)=>i._id === editingItem._id ? res.data.data : i));
                __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Projects$2d$for$2d$portfolio$2d$versions$2f$multi$2d$tenant__hospitality$2f$client$2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Menu item updated!");
            } else {
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Projects$2d$for$2d$portfolio$2d$versions$2f$multi$2d$tenant__hospitality$2f$client$2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createMenuItem"])(payload);
                setItems((prev)=>[
                        ...prev,
                        res.data.data
                    ]);
                __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Projects$2d$for$2d$portfolio$2d$versions$2f$multi$2d$tenant__hospitality$2f$client$2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Menu item created!");
            }
            resetForm();
            setShowItemModal(false);
        } catch (err) {
            console.error("Item operation error:", err);
            __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Projects$2d$for$2d$portfolio$2d$versions$2f$multi$2d$tenant__hospitality$2f$client$2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(err.response?.data?.error || (editingItem ? "Failed to update item" : "Failed to create item"));
        } finally{
            setItemSaving(false);
        }
    };
    ...
    const handleDeleteItem = async (id)=>{
        if (confirm("Are you sure you want to delete this item?")) {
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Projects$2d$for$2d$portfolio$2d$versions$2f$multi$2d$tenant__hospitality$2f$client$2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteMenuItem"])(id);
                setItems((prev)=>prev.filter((i)=>i._id !== id));
                __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Projects$2d$for$2d$portfolio$2d$versions$2f$multi$2d$tenant__hospitality$2f$client$2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Item deleted!");
            } catch  {
                __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Projects$2d$for$2d$portfolio$2d$versions$2f$multi$2d$tenant__hospitality$2f$client$2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Failed to delete item");
            }
        }
    };
    const toggleAvailability = async (item)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Projects$2d$for$2d$portfolio$2d$versions$2f$multi$2d$tenant__hospitality$2f$client$2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateMenuItemAvailability"])(item._id, !item.isAvailable);
            setItems((prev)=>prev.map((i)=>i._id === item._id ? {
                        ...i,
                        isAvailable: !i.isAvailable
                    } : i));
        } catch  {
            __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Projects$2d$for$2d$portfolio$2d$versions$2f$multi$2d$tenant__hospitality$2f$client$2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Failed to update availability");
        }
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0hjf-md._.js.map