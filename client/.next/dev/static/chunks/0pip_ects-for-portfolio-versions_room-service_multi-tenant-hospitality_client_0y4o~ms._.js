...
"[project]/OneDrive/Desktop/Projects-for-portfolio-versions/room-service/multi-tenant-hospitality/client/app/admin/login/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LoginPage() {
    ...
    const { login } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Projects$2d$for$2d$portfolio$2d$versions$2f$room$2d$service$2f$multi$2d$tenant$2d$hospitality$2f$client$2f$store$2f$useAdminStore$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAdminStore"])();
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Projects$2d$for$2d$portfolio$2d$versions$2f$room$2d$service$2f$multi$2d$tenant$2d$hospitality$2f$client$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loginAdmin"])({
                email,
                password
            });
            const { user, token } = res.data;
            login(user, token);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Projects$2d$for$2d$portfolio$2d$versions$2f$room$2d$service$2f$multi$2d$tenant$2d$hospitality$2f$client$2f$lib$2f$socket$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["connectSocket"])(token);
...
//# sourceMappingURL=0pip_ects-for-portfolio-versions_room-service_multi-tenant-hospitality_client_0y4o~ms._.js.map